...
#configuring path for extension for ALICE

current_dir = os.path.dirname(os.path.abspath(__file__))

# Move up to the `music` directory
music_dir = os.path.dirname(current_dir)

# Move up to the root directory of the extension
extension_root = os.path.dirname(music_dir)
...
def play_song_in_background(song_title):
    try:
        ...
        output_path =os.path.join(extension_root,'Infer_buffer','song.mp3') 
        ...
        try:
            ...
            wav_path = os.path.join(extension_root,'Infer_buffer','song.wav') 
