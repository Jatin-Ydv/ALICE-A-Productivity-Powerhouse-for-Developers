...
def callback(recognizer,audio):
    ...
    prompt_audio_path=os.path.join(current_dir,'Infer_buffer','prompt.wav')
    ...
    if clean_prompt:
        ...
        if 'take screenshot' in call:
            ...
            speak(phrase)
            take_screenshot()
            photo_path=os.path.join(current_dir,'Infer_buffer','screenshot.jpg')
            ...
            speak(phrase)
            web_cam_capture()
            webcam_path=os.path.join(current_dir,'Infer_buffer','webcam.jpg')
...
def start_listening():
    ...
    speak('Starting the bot ... \n')
    
    with source as s:
        r.adjust_for_ambient_noise(s,duration=2)
        
    print('\n Say', wake_word, 'followed with your prompt. \n')
    speak('\n Say ALICE followed with your prompt. \n')
...
def extract_prompt(transcribed_text,wake_word):
    ...
    if match:
        ...
        speak("I'm sorry! I didn't get what you said!")
        return None
